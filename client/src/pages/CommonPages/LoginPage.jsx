...
//   //     // Ensure navigation only happens if the user is valid and active
//   //     if (user.isAdmin) {
//   //       toast.success("Admin login successful!");
//   //       setTimeout(() => {
//   //         navigate("/admin-dashboard", { replace: true });
//   //       }, 2000);
//   //     } else if (user.isActive) {  // Check if the user is active before navigating
//   //       toast.success("Login successful!");
//   //       setTimeout(() => {
//   //         navigate("/home", { replace: true });
//   //       }, 2000);
...
//         }, 2000);
//       } else {
//         // Prevent any further action if account is deactivated
//         toast.error("Your account has been deactivated. Please contact the administrator.");
