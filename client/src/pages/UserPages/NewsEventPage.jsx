...
const NewsEventPage = () => {
  ...
  if (error) {
    return (
      <div className={`min-h-screen flex items-center justify-center text-red-500 ${isDarkTheme ? 'bg-gray-900' : 'bg-white'}`}>
        {error}
      </div>
    );
  }
  ...
  return (
    <div className={isDarkTheme ? 'bg-gray-900' : 'bg-white'}>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className={`text-3xl font-bold mb-8 ${isDarkTheme ? 'text-white' : 'text-gray-900'}`}>News & Events</h1>
